    ...
    <div class="container-fluid" style="display: inline;">
        ...
        <?php
            if(isset($_SESSION["UserID"]))
            {
                ...
                {
                    ?>
                        <button id="createThreadBtn" class="btn btn-primary" style="float: right; margin-left:10px"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">

    ...
    <div class="container-fluid">
            ...
            <div class="row" style="width: 100%; margin: 0px;">
                ...
                <div class="card col-lg-9" style="width: 80%; padding: 0px;">
                    <div class="card-body" style="padding: 0px;">
                        ...
                        <textarea class="form-control" name="" id="" style="resize: none; width: 100%; height: 80%; padding-left:10px; padding-top:10px;" cols="30" rows="10" placeholder="Message"></textarea>                    </div>
                </div>
            </div>
        </div>
        <div class="card" style="width: 100%;">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-outline-success" style="float: right;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16">
